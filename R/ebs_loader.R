...
DISEASE_KEYWORDS <- list(
  ...
  crs           = c("先天性風しん","congenital rubella","CRS","congenital rubella syndrome"),
  ...
  rubella       = c("風疹","rubella","German measles","rubella case","rubella outbreak",
                    "rubella vaccine","rubella immunity"),
  measles       = c("麻疹","measles","はしか","rubeola","measles case","measles outbreak",
