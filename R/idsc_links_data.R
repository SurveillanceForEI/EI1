...
IDSC_OVERSEAS <- list(
  ...
  .idsc_overseas("National Notifiable Diseases Surveillance System (NNDSS)", "米国疾病予防管理センター（CDC）",
                 "https://www.cdc.gov/nndss/infectious-disease/index.html", "米州地域", country_en = "USA"),
  .idsc_overseas("National Surveillance of Bacterial Foodborne Illnesses (Enteric Diseases)", "米国疾病予防管理センター（CDC）",
                 "https://www.cdc.gov/national-enteric-surveillance/about/index.html", "米州地域", country_en = "USA"),
  .idsc_overseas("Pediatric Acute Respiratory Illness (ARI) Interactive Dashboard", "米国疾病予防管理センター（CDC）",
                 "https://www.cdc.gov/nvsn/php/ari-dashboard/", "米州地域", country_en = "USA"),
