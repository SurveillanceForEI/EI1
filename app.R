    ...
    tabBox(width=12, id="main_tabs",
      ...
      tabPanel("Notes", icon=icon("circle-info"),
        tags$div(style="padding:20px;max-width:960px;font-size:0.9em;line-height:1.8;",
          ...
          tags$h5("主なデータソース"),
          tags$p(style="font-size:0.85em;color:#888;",
            "情報量の多い代表的なソースを掲載しています（全ソースの一覧ではありません）。",
            "このほか、全47都道府県・多数の市区町村の公式サイト、各国保健当局等、100を超えるソースから取得しています。"),
          tags$table(class="table table-bordered table-sm", style="font-size:0.85em;",
            ...
            tags$tbody(
              ...
              tags$tr(tags$td("WHO Disease Outbreak News / WHOアフリカ地域事務局"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("ProMED Mail"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("ECDC"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("米国CDC（Health Alerts / Newsroom / Outbreaks）"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("ReliefWeb（日本関連）"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("CIDRAP（疾患別トピックフィード多数）"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("Outbreak News Today / Avian Flu Diary"), tags$td("国際"), tags$td("英語")),
              tags$tr(tags$td("WOAH（世界動物保健機関） / 各国保健当局（ウガンダ保健省等）"), tags$td("国際"), tags$td("英語")),
              ...
              tags$tr(tags$td("日テレNEWS（社会）/ 北海道新聞 / 宮崎日日新聞 / 熊本日日新聞"), tags$td("地方紙・地方局"), tags$td("日本語")),
              tags$tr(tags$td("日本感染症学会"), tags$td("国内学会"), tags$td("日本語")),
