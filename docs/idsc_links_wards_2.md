...
|---|---|---|---|---|
| 渋谷区 | 渋谷区感染症週報・月報 | https://www.city.shibuya.tokyo.jp/kenko/kansen/kansen-jokyo/kansen-doko.html | (RSS未発見) | 感染症情報ページURL: High（内容確認済み、定点報告・全数報告の週報/月報を掲載）。RSS: Low — サイト内・検索とも `<link rel="alternate" type="application/rss+xml">` やRSS配信ページが見つからず。渋谷区は現状RSS配信を提供していない可能性が高い（プッシュ通知・SNS中心）。ニュース一覧は https://www.city.shibuya.tokyo.jp/contents/news/ （HTML一覧のみ）。 |
...
| 荒川区 | 感染症発生情報 | https://www.city.arakawa.tokyo.jp/a034/kenkouiryou/kansenshou/hasseidoukou.html （感染症トップ: https://www.city.arakawa.tokyo.jp/kenkouiryou/kansenshou/index.html） | https://www.city.arakawa.tokyo.jp/kouhou/news/index.html （「最新ニュース一覧」＝RSS配信ありと言及されるが具体的なfeed URL不明） | 感染症情報ページURL: High — 検索結果に「感染症発生情報【第25週更新】」の実ページを確認、週次更新の実データページ。RSS: Low — 「最新ニュースRSS」が存在するとの言及はあるが、具体的なXML/RSSファイルURLは検索で特定できず。RSS配信案内ページも未発見。 |
