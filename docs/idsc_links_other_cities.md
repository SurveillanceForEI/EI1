...
| 藤沢市（神奈川県） | 藤沢市感染症発生状況（藤沢市保健所） | https://www.city.fujisawa.kanagawa.jp/kenko/iryo/kansensho/kansensho/hassei/index.html （ユーザー確認済み） | RSS配信はないが、ユーザー提供の新着情報一覧 https://www.city.fujisawa.kanagawa.jp/shinchaku/index.html （`table.news_tbl tr > td.news_date（年なしM月D日）/td.news_link`構造。「藤沢市感染症発生状況」自体もこの新着一覧に掲載される）をHTMLスクレイピングで直接取得（fetch_fujisawa_news）し、EBS_SOURCESに追加済み（id: city_fujisawa）。 | RSSはなくHTML直接解析で解決。年なし日付のため未来3日超は前年扱いに補正。 |
